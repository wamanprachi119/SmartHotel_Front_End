  ...
  const updateOrderStatus = async (orderId, status) => {
    ...
    try {
      ...
      if (err.message.includes("timed out") || err.message.includes("fetch")) {
        showToast("Cannot reach backend server. Check your internet connection or try refreshing.", "error");
      } else {
      ...
      {!backendOnline && (
        <div style={{
          ...
          <span>
            ...
            Backend server is unreachable. Check your connection and refresh.
          </span>
        </div>
      )}
